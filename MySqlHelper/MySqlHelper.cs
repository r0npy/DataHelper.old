...
namespace Universal.Data
{
    ...
    public static class MySqlHelper
    {
        ...
        public static DataSet ExecuteDataSet(string connectionString, CommandType commandType,
            string comandoSql, params MySqlParameter[] args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataSet ExecuteDataSet(MySqlTransaction transaction, CommandType commandType,
            string comandoSql, params MySqlParameter[] args)
        {
        ...
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType,
            string sqlCommand, params MySqlParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static MySqlDataReader ExecuteReader(string connectionString, CommandType commandType,
            string sqlCommand, params MySqlParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
            return conexion.ExecuteReader(sqlCommand, commandType, args) as MySqlDataReader;
        }
        ...
        {
            var conexion = new UniversalSql();
            return conexion.ExecuteReader(transaction, sqlCommand, commandType, args) as MySqlDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static Object ExecuteScalar(MySqlTransaction transaction, CommandType commandType,
            string sqlCommand, params MySqlParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static ArrayList ExecuteOutputValue(MySqlTransaction transaction, CommandType commandType,
            string sqlCommand, params MySqlParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(MySqlTransaction transaction, CommandType commandType,
            string sqlCommand, params MySqlParameter[] args)
        {
            var conexion = new UniversalSql();
