...
namespace Universal.Data
{
    ...
    abstract class DbDataAccess
    {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public ArrayList ExecuteOutputValue(string sqlCommand, CommandType commandType, params IDbDataParameter[] args)
        {
            try
            {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public ArrayList ExecuteOutputValue(IDbTransaction transaction, string sqlCommand, CommandType commandType, params IDbDataParameter[] args)
        {
            var result = new ArrayList();
            var com = Comando(transaction, sqlCommand, commandType);
            CargarParametros(com, args);
