...
namespace Universal.Data
{
    ...
    public static class OdbcHelper
    {
        ...
        public static DataSet ExecuteDataSet(string connectionString, CommandType commandType,
            string comandoSql, params OdbcParameter[] args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataSet ExecuteDataSet(OdbcTransaction transaction, CommandType commandType,
            string comandoSql, params OdbcParameter[] args)
        {
        ...
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(OdbcTransaction transaction, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static OdbcDataReader ExecuteReader(string connectionString, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
            return conexion.ExecuteReader(sqlCommand, commandType, args) as OdbcDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static OdbcDataReader ExecuteReader(OdbcTransaction transaction, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql();
            return conexion.ExecuteReader(transaction, sqlCommand, commandType, args) as OdbcDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static Object ExecuteScalar(OdbcTransaction transaction, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static ArrayList ExecuteOutputValue(OdbcTransaction transaction, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(OdbcTransaction transaction, CommandType commandType,
            string sqlCommand, params OdbcParameter[] args)
        {
            var conexion = new UniversalSql();
