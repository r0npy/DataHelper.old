...
namespace Universal.Data
{
    ...
    public static class FirebirdHelper
    {
        ...
        public static DataSet ExecuteDataSet(string connectionString, CommandType commandType,
            string comandoSql, params FbParameter[] args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataSet ExecuteDataSet(FbTransaction transaction, CommandType commandType,
            string comandoSql, params FbParameter[] args)
        {
        ...
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(FbTransaction transaction, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static FbDataReader ExecuteReader(string connectionString, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
            return conexion.ExecuteReader(sqlCommand, commandType, args) as FbDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static FbDataReader ExecuteReader(FbTransaction transaction, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql();
            return conexion.ExecuteReader(transaction, sqlCommand, commandType, args) as FbDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static Object ExecuteScalar(FbTransaction transaction, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static ArrayList ExecuteOutputValue(FbTransaction transaction, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(FbTransaction transaction, CommandType commandType,
            string sqlCommand, params FbParameter[] args)
        {
            var conexion = new UniversalSql();
