...
namespace Universal.Data
{
    ...
    public static class OracleHelper
    {
        ...
        public static DataSet ExecuteDataSet(string connectionString, CommandType commandType,
            string comandoSql, params OracleParameter[] args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataSet ExecuteDataSet(OracleTransaction transaction, CommandType commandType,
            string comandoSql, params OracleParameter[] args)
        {
        ...
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType,
            string sqlCommand, params OracleParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
        ...
        {
            var conexion = new UniversalSql(connectionString);
            return conexion.ExecuteReader(sqlCommand, commandType, args) as OracleDataReader;
        }
        ...
        {
            var conexion = new UniversalSql();
            return conexion.ExecuteReader(transaction, sqlCommand, commandType, args) as OracleDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static Object ExecuteScalar(OracleTransaction transaction, CommandType commandType,
            string sqlCommand, params OracleParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static ArrayList ExecuteOutputValue(OracleTransaction transaction, CommandType commandType,
            string sqlCommand, params OracleParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(OracleTransaction transaction, CommandType commandType,
            string sqlCommand, params OracleParameter[] args)
        {
            var conexion = new UniversalSql();
