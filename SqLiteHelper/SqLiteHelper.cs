...
namespace Universal.Data
{
    ...
    public static class SqLiteHelper
    {
        ...
        public static DataSet ExecuteDataSet(string connectionString, CommandType commandType,
            string comandoSql, params SQLiteParameter[] args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataSet ExecuteDataSet(SQLiteTransaction transaction, CommandType commandType,
            string comandoSql, params SQLiteParameter[] args)
        {
        ...
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType,
            string sqlCommand, params SQLiteParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(SQLiteTransaction transaction, CommandType commandType,
            string sqlCommand, params SQLiteParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static SQLiteDataReader ExecuteReader(string connectionString, CommandType commandType,
            string sqlCommand, params SQLiteParameter[] args)
        {
            var conexion = new UniversalSql(connectionString);
            return conexion.ExecuteReader(sqlCommand, commandType, args) as SQLiteDataReader;
        }
        ...
        {
            var conexion = new UniversalSql();
            return conexion.ExecuteReader(transaction, sqlCommand, commandType, args) as SQLiteDataReader;
        }
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static Object ExecuteScalar(SQLiteTransaction transaction, CommandType commandType,
            string sqlCommand, params SQLiteParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static ArrayList ExecuteOutputValue(SQLiteTransaction transaction, CommandType commandType,
            string sqlCommand, params SQLiteParameter[] args)
        {
            var conexion = new UniversalSql();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(SQLiteTransaction transaction, CommandType commandType,
            string sqlCommand, params SQLiteParameter[] args)
        {
            var conexion = new UniversalSql();
